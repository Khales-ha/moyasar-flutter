...
- [Apple Pay] Fix the charge being built from the live config once the sheet closed. The config approved at the press is now the one charged, so an order that changed while the sheet was up cannot move the charge onto it.
